...
'                    <span style="font-size: 21px;font-weight: bold;color:#a80c03">Watch Demo</span>'+
'                </a>'+
'            </div>'+
'            <div class="videoPrototype" style="flex: 0 33.33333333%;">'+
...
formHeaderCtn.setAttribute('style', 'left: 33px;width: 746px;position: absolute;margin-left: calc((100% - 980px) * 0.5);top:788px;');
...
window.toggleAccordion = function() {
    ...
    if(isAccordionOpen) {
        ...
        formHeaderCtn.setAttribute('style', 'left: 33px;width: 746px;position: absolute;margin-left: calc((100% - 980px) * 0.5);top: 920px;');
